...
Data can be downloaded from zenodos [here](). The .rdata file contains several objects that will be used for simulation experiments, as well as evaluations on real data:
